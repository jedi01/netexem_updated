...
class Payments_model extends CRM_Model
{
    ...
    add($data, $subscription = false)
    {
        ...
        // Handle Invoice PDF generator
            ...
            $data['payments']      = $this->payments_model->get_invoice_payments($invoice->id);
            ...
            $attach = format_invoice_number($invoice->id).".pdf";
                ...
                foreach ($contacts as $contact) {
                    ...
                    if ($attachPaymentReceipt) {
                        $template->add_attachment([
                                'attachment' => $file,
                                'filename'   =>  format_invoice_number($payment->invoiceid) . '.pdf',
