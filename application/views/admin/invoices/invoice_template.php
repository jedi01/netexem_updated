   ...
   <div class="panel-body">
      ...
      <div class="row">
         ...
         <div class="col-md-6">
           ...
           <!--  <label for="unlimited_cycles">Select Payment Mode</label>
            <select name="payment_type" id="repeat_type_custom" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           <option value="0">Card</option>
                           <option value="1">Pay By Check</option>
                        </select> -->
         </div>
      </div>
   </div>
