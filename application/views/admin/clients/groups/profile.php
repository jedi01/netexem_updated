      ...
      <div class="tab-content">
         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  <?php $value=( isset($client) ? $client->account_number : ''); ?>
                  <?php $attrs = (isset($client) ? array() : array('autofocus'=>true)); ?>
                  <?php echo render_input( 'account_number', 'client_account_number',$value,'text',$attrs); ?>
                  ...
                  <?php echo render_input( 'phonenumber', 'client_phonenumber',$value,'text',array(),array(),'','phonenumberRegex'); ?>
        ...
        <!--           <?php if(!isset($client)){ ?>
               ...
               <?php $value=( isset($client) ? $client->address : ''); ?>
                  <?php echo render_input( 'address', 'client_address',$value,'text',array(),array(),'','street_number'); ?>
                  <?php $value=( isset($client) ? $client->address2 : ''); ?>
                  <?php echo render_input( 'address2', 'client_address_2',$value,'text',array(),array(),'','route'); ?>
                  <?php $value=( isset($client) ? $client->city : ''); ?>
                  <?php echo render_input( 'city', 'client_city',$value,'text',array(),array(),'','locality'); ?>
                  <?php $value=( isset($client) ? $client->state : ''); ?>
                  <?php echo render_input( 'state', 'client_state',$value,'text',array(),array(),'','administrative_area_level_1'); ?>
                  <?php $value=( isset($client) ? $client->zip : ''); ?>
                  <?php echo render_input( 'zip', 'client_postal_code',$value,'text',array(),array(),'','postal_code'); ?>
                 <!--  <?php $countries= get_all_countries();
                     ...
                     <div class="col-md-6">
                        <div class="checkbox">
                           <input type="checkbox"  class="billing_addr_same">
                           <label for="billing_addr">Billing Address is same</label>
                       </div>
                     ...
                     <div class="col-md-6">
                       <div class="checkbox">
                           <input type="checkbox" class="shipping_addr_same">
                           <label for="shipping_addr">Shipping Address is same</label>
                       </div>
                     </div>
                  <?php } ?>
               </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                       ...
                       <?php $value=( isset($client) ? $client->billing_street : ''); ?>
                        <?php echo render_input( 'billing_street', 'billing_street',$value,'text',array(),array(),'','street_number1'); ?>
                         <?php $value=( isset($client) ? $client->billing_street2 : ''); ?>
                        <?php echo render_input( 'billing_street2', 'billing_address2',$value,'text',array(),array(),'','route1'); ?>
                        <?php $value=( isset($client) ? $client->billing_city : ''); ?>
                        <?php echo render_input( 'billing_city', 'billing_city',$value,'text',array(),array(),'','locality1'); ?>
                        <?php $value=( isset($client) ? $client->billing_state : ''); ?>
                        <?php echo render_input( 'billing_state', 'billing_state',$value,'text',array(),array(),'','administrative_area_level_11'); ?>
                        <?php $value=( isset($client) ? $client->billing_zip : ''); ?>
                        <?php echo render_input( 'billing_zip', 'billing_zip',$value,'text',array(),array(),'','postal_code1'); ?>
                     ...
                     <div class="col-md-6">
                        ...
                        <?php echo render_input( 'shipping_street', 'shipping_street',$value,'text',array(),array(),'','street_number2'); ?>
                        <?php $value=( isset($client) ? $client->shipping_street2 : ''); ?>
                        <?php echo render_input( 'shipping_street2', 'shipping_street2',$value,'text',array(),array(),'','route2'); ?>
                        <?php $value=( isset($client) ? $client->shipping_city : ''); ?>
                        <?php echo render_input( 'shipping_city', 'shipping_city',$value,'text',array(),array(),'','locality2'); ?>
                        <?php $value=( isset($client) ? $client->shipping_state : ''); ?>
                        <?php echo render_input( 'shipping_state', 'shipping_state',$value,'text',array(),array(),'','administrative_area_level_12'); ?>
                        <?php $value=( isset($client) ? $client->shipping_zip : ''); ?>
                        <?php echo render_input( 'shipping_zip', 'shipping_zip',$value,'text',array(),array(),'','postal_code2'); ?>
