               ...
               <div class="panel-body">
                  ...
                  <?php if(has_permission('customers','','view') || have_assigned_customers()) {
                     ...
                     if(!has_permission('customers','','view')){
                         $where_summary = ' AND userid IN (SELECT customer_id FROM '.db_prefix().'customeradmins WHERE staff_id='.get_staff_user_id().')';
                     }
                     ?>
                  ...
                  <?php
                  //echo $table_last_page;
                     $table_data = array();
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',
                       array(
                         'name'=>_l('client_account_number'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-account_number')
                        ),
                         array(
...
<script>
   ...
   if(<?php echo $table_last_page ?>){
       //alert("asdfsd");
       //$("#DataTables_Table_0").DataTable().page('last').draw('page');
   }
</script>
</body>
</html>
