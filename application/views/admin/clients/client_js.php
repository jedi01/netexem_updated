...
$(function() {
        ...
        $("input:checkbox[class='billing_addr_same']").click(function(){
        if($(this). prop("checked") == true){
          $('input[name="billing_street"]').val($('input[name="address"]').val());
          $('input[name="billing_street2"]').val($('input[name="address2"]').val());
      ...
      $("input:checkbox[class='shipping_addr_same']").click(function(){
        if($(this). prop("checked") == true){
          $('input[name="shipping_street"]').val($('input[name="address"]').val());
          $('input[name="shipping_street2"]').val($('input[name="address2"]').val());
          ...
          $('input[name="shipping_street2"]').val('');
      ...
      $('.phonenumberRegex').usPhoneFormat({
            format: '(xxx) xxx-xxxx',
        });
