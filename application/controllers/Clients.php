...
class Clients extends Clients_controller
{
    ...
    public function invoices($status = false)
    {
        ...
        $order_by = "duedate";
        $odr_method = "ASC";
        $data['duedate_invoice'] = $this->invoices_model->get_early_expire_invioce($order_by,$odr_method);
        ...
        $recurring_where['clientid'] = get_client_user_id();
        $data['recurringInvoice'] = $this->invoices_model->get('',$recurring_where);
